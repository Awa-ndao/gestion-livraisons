...
<div class="card">
    <div class="card-header">
        <h5 class="mb-0"><i class="bi bi-pencil"></i> Modifier Livraison</h5>
    </div>
    <div class="card-body">
        <form action="{{ route('livraisons.update', $livraison) }}" method="POST">
            ...
            <div class="mb-3">
                ...
                <input type="date" name="date_livraison" class="form-control @error('date_livraison') is-invalid @enderror" value="{{ old('date_livraison', $livraison->date_livraison) }}">
            ...
            <div class="mb-3">
                ...
                <select name="colis_id" class="form-select @error('colis_id') is-invalid @enderror">
                    ...
                    @foreach($colis as $coli)
                        <option value="{{ $coli->id }}" {{ old('colis_id', $livraison->colis_id) == $coli->id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <select name="livreur_id" class="form-select @error('livreur_id') is-invalid @enderror">
                    ...
                    @foreach($livreurs as $livreur)
                        <option value="{{ $livreur->id }}" {{ old('livreur_id', $livraison->livreur_id) == $livreur->id ? 'selected' : '' }}>
            ...
            <div class="mb-3">
                ...
                <select name="statut" class="form-select @error('statut') is-invalid @enderror">
                    <option value="planifiée" {{ old('statut', $livraison->statut) == 'planifiée' ? 'selected' : '' }}>Planifiée</option>
